...
export const officeStoreStaff: OfficeStoreStaff[] = [
  {
    id: 'staff_eli',
    name: 'Eli',
...
export const getStaffByState = (state: StaffState) => 
  officeStoreStaff.filter(staff => staff.state === state);

export const getActiveStaff = () => getStaffByState('active');
export const getAvailableStaff = () => getStaffByState('available');
export const getComingSoonStaff = () => getStaffByState('coming_soon');
