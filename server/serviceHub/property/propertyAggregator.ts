...
export async function aggregatePropertyData(
  ...
  const facts: PropertyData['facts'] = {
    ...
    // ─── Pass A: estimator-essential ATTOM data passthrough ─────────
    roofCover: adamFacts?.roofCover,
    permits: adamFacts?.permits,
    mortgageLender: adamFacts?.mortgageLender,
    mortgageAmount: adamFacts?.mortgageAmount,
    mortgageDate: adamFacts?.mortgageDate,
    mortgageLoanType: adamFacts?.mortgageLoanType,
    ltvRatio: adamFacts?.ltvRatio,
    availableEquity: adamFacts?.availableEquity,
    currentLoanBalance: adamFacts?.currentLoanBalance,
    estimatedMonthlyPayment: adamFacts?.estimatedMonthlyPayment,
    lastSalePricePerSqft: adamFacts?.lastSalePricePerSqft,
    lastSaleType: adamFacts?.lastSaleType,
    lastSaleArmsLength: adamFacts?.lastSaleArmsLength,
    appreciationPct: adamFacts?.appreciationPct,
    avmConfidenceScore: adamFacts?.avmConfidenceScore,
    avmFsd: adamFacts?.avmFsd,
    avmPricePerSqft: adamFacts?.avmPricePerSqft,
    avmDate: adamFacts?.avmDate,
    estimatedRent: adamFacts?.estimatedRent,
    estimatedRentLow: adamFacts?.estimatedRentLow,
    estimatedRentHigh: adamFacts?.estimatedRentHigh,
    taxAssessedTotal: adamFacts?.taxAssessedTotal,
    taxAssessedLand: adamFacts?.taxAssessedLand,
