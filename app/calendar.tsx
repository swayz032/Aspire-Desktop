...
import { useRealtimeCalendarEvents, type CalendarEvent } from '@/hooks/useRealtimeCalendarEvents';
...
function CalendarScreen() {
  ...
  // Realtime calendar events — dual path: Supabase Realtime + 30s polling fallback
  const { events: calendarEvents, loading } = useRealtimeCalendarEvents();
          ...
          <View style={[styles.agendaSection, isWideScreen && styles.agendaSectionWide]}>
            ...
            <View style={styles.statsRow}>
              ...
              <View style={[styles.statItem, { borderLeftColor: '#af52de' }]}>
                <Text style={styles.statValue}>
                  {calendarEvents.filter(e => e.type === 'call').length}
                </Text>
